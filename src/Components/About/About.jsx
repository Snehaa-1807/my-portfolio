...
const About = () => {
  return (
    <div
      id="About"
      className="text-rose-300 flex flex-col md:flex-row gap-10 items-center justify-center bg-black shadow-xl mx-0 md:mx-20 bg-opacity-30 rounded-lg p-6 md:p-12"
    >
      {/* Image Section */}
      ...
      <div className="max-w-xl">
        ...
        <div className="flex gap-3 py-4">
          <IoArrowForward size={30} className=" text-white mt-1" />
          <div>
            <h1 className="text-xl text-white md:text-2xl font-semibold">Frontend Developer</h1>
        ...
        <div className="flex gap-3 py-4">
          <IoArrowForward size={30} className="mt-1 text-white" />
          <div>
            <h1 className=" text-white text-xl md:text-2xl font-semibold">Database Developer</h1>
            <p className="text-sm md:text-md">
        ...
        <div className="flex gap-3 py-4">
          <IoArrowForward size={30} className="text-white mt-1" />
          <div>
            <h1 className="text-white text-xl md:text-2xl font-semibold">Backend Developer</h1>
            <p className="text-sm md:text-md">
